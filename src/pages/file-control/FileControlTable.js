...
const FileControlTable = ({ data, onEdit, noExpire }) => { 
...
const columns = [
  ...
  }, 
  {
    ...
    render: ({file_uuid}) => (
      <Space> 
        <Button size='small' onClick={()=>{ onEdit(file_uuid) }} style={{lineHeight:'1rem', backgroundColor: '#0958d9', color: '#fff',borderColor: '#0958d9'  }}>
          <EditOutlined />
        </Button>
      </Space>
    ),
