...
export default function PO() {
  ...
  const handleView = (data) => {
    navigate("view", {
      state: { config: { ...manageConfig, title: "View", code: data?.srcode } },
      replace: true,
    });
  };
  ...
  const poColumn = columns(searchInput, columnSearchProp, {
    ...
    <>
      <div className="layout-content">
        <Space
          direction="vertical"
          size="middle"
          className="width-100 sample-request"
        >
          <Row className="m-0">
            <Col span={12}>
              <Button
